...
# --- Logic to get NEXT Serial Number ---
def get_next_sl_no():
...
st.markdown("<style>.receipt-card { background-color: white; padding: 25px; border-radius: 12px; border: 2px solid #2e7d32; color: black; }</style>", unsafe_allow_html=True)
...
with col_preview:
    ...
    if generate_btn and f_name:
        ...
        <div class="receipt-card">
            <h2 style="text-align:center; color:#2e7d32;">PADDY PURCHASE RECEIPT</h2>
            ...
            <table style="width:100%; line-height: 2;">
                ...
                <tr style="font-weight:bold; color:#2e7d32;"><td>GROSS TOTAL:</td><td style="text-align:right">₹{gross:.2f}</td></tr>
        ...
        with cp1:
            ...
            st.download_button("📩 Download PDF Bill", pdf_bytes, f"Bill_{current_sl}.pdf")
        with cp2:
            if f_phone:
